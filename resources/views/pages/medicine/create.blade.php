...
<div class="container-fluid main-container">
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            @if (isset($medicine))
                {!! Form::model($medicine, ['url'=>URL::route('medicine.update', $id), 'autocomplete'=>'off', 'files' => true, 'method' => 'PUT']) !!}
                {!! Form::hidden('id', null) !!}
            @else
                {!! Form::open(['url'=>URL::route('medicine.store'), 'autocomplete'=>'off', 'files' => true]) !!}
            @endif
